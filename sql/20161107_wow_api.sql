...
--
-- Client :  localhost
-- Généré le :  Lun 07 Novembre 2016 à 13:54
...
CREATE TABLE `blizzard_encounter` (
  ...
  `warcraftlog_id` int(11) NOT NULL
...
INSERT INTO `blizzard_encounter` (`encounter_id`, `zone_id`, `name`, `warcraftlog_id`) VALUES
(93394, 8440, 'Helya', 2008),
(100497, 8026, 'Ursoc', 1841),
(102679, 8026, 'Dragons of Nightmare', 1854),
(103160, 8026, 'Nythendra', 1853),
(103769, 8026, 'Xavius', 1864),
(105393, 8026, 'Il\'gynoth, The Heart of Corruption', 1873),
(111000, 8026, 'Elerethe Renferal', 1876),
(113534, 8026, 'Cenarius', 1877),
(114344, 8440, 'Guarm', 1962),
(115323, 8440, 'Odyn', 1858);
...
INSERT INTO `blizzard_zone` (`zone_id`, `name`, `warcraftlog_id`) VALUES
(8026, 'The Emerald Nightmare', 10),
(8440, 'Trial of Valor', 12);
